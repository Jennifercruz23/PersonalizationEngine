// src/lib.rs
/*
 * Core library for PersonalizationEngine
 */
...
#[derive(Debug)]
pub struct PersonalizationEngineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PersonalizationEngineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PersonalizationEngine processing");
    
    let mut processor = PersonalizationEngineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PersonalizationEngineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PersonalizationEngineProcessor::new(false);
